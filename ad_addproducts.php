    ...
    <main id="main" class="main">
        ...
        <section class="section">
            <div class="row">
                ...
                <div class="alert alert-success bg-success text-light border-0 alert-dismissible fade show alert-dismissible fade show col-sm-6"
                ...
                <div class="card recent-sales overflow-auto">
                    ...
                    <div class="card-body">
                        <button type="button" class="btn btn-primary mt-3" data-bs-toggle="modal"
                            data-bs-target="#verticalycentered" style="float: right">
                        ...
                        <table id="data-table" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="ad_view_products.php?details=<?= $row['id'] ?>" type="button"
                                            class="btn btn-info"><i class="bi bi-eye"></i></a>
                                        <a href="ad_edit_products.php?edit=<?= $row['id'] ?>" type="button"
                                            class="btn btn-success"><i class="bx bxs-edit"></i></a>
                                        <a href="ad_delete_products.php?edit=<?= $row['id'] ?>" type="button"
                            ...
                            <div class="modal-content">
                                <div class="card">
                                    <div class="card-body ">
                                        ...
                                        <a href="ad_addproducts.php" type="button" class="btn btn-danger"
                                            style="float: right;">
                                            <i class="bx bx-x"></i></a>
                                        ...
                                        <form action="ad_action_product.php" method="post"
                                            ...
                                            <div class="row mb-3">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <select name="cat_id" class="form-select"
                                                            ...
                                                            <?php $sql_category = 'SELECT * FROM categories WHERE deleted_at IS NULL'; ?>
                                                            <?php $qry_category = mysqli_query($conn, $sql_category); ?>
                                                            <?php while ($get_category = mysqli_fetch_array($qry_category)) { ?>
                                                            <option value="<?php echo $get_category['id']; ?>">
                                                            <?php echo $get_category['cat_name']; ?>
                                                            </option>
                                                            <?php } ?>
                                                        </select>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-sm-6 form_error" <?php if (isset($code_error)) : ?>
                                                        <?php endif ?>>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="prod_qntty"
                                                            value="<?= $prod_qntty ?>" class="form-control"
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <select name="isfeatured" value="<?= $isfeatured ?>"
