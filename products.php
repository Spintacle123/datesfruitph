...
<div class="small-container max-h-screen">
	<div class="flex flex-col items-center">
		<div class="flex flex-row pt-20 ml-40">
			<div class="flex flex-row px-2 justify-center items-center border hover:border-[#FF8000] rounded-tr-lg rounded-bl-lg w-[15rem]">
				<div class="py-1 w-[12rem]">
					<input type="text" id="search-input" class="bg-[#EFEFEF] ml-2 w-full" placeholder="Search Products">
				</div>
				<button onclick="performSearch()">
					<div class="flex p-0.5 border rounded-tr-lg rounded-bl-lg bg-[#DC7105] justify-center items-center">
