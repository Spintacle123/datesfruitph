...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Update Giftings Details</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="ad_index.php">Dashboard</a></li>
          <li class="breadcrumb-item active">/ Update Giftings Details</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      ...
      <div class="col-lg-6 mx-auto">
        <div class="card">
          <div>
            <div class="card-body">
              <a href="ad_addgiftings.php" type="button" class="btn btn-info" style="float: right;">
              ...
              <form action="ad_action_giftings.php" method="post" enctype="multipart/form-data">
                <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    <div class="col-sm-4">
                      <input type="submit" name="update" class="btn btn-primary" value="Update Giftings">
                    </div>
                  </div>
